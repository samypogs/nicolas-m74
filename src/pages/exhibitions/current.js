...
const CurrentLanding = class extends React.Component {
  render() {
...
export default props => (
  <StaticQuery
    query={graphql`
      query {
        allMarkdownRemark(filter: { frontmatter:  { templateKey: { eq:"exhibitions"}, current: { eq: true}}}){
          edges {
            node {
              id
              html
    ...
    `}
    render={data => <CurrentLanding data={data}/>}
  />
)
